...
<body>
    ...
    @include('admin.partials.sidebar', ['activeMenu' => 'courses'])
        ...
        <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="duration_hours" name="duration_hours" value="{{ old('duration_hours') }}" min="1" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="discount_price" name="discount_price" value="{{ old('discount_price') }}" min="0" step="0.01">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label for="max_students" class="form-label">Max Students</label>
                            <input type="number" class="form-control" id="max_students" name="max_students" value="{{ old('max_students') }}" min="1">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="requires_entry_test" name="requires_entry_test" value="1" {{ old('requires_entry_test') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="min_entry_test_score" name="min_entry_test_score" value="{{ old('min_entry_test_score', 60) }}" min="0" max="100" disabled>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="has_certificate" name="has_certificate" value="1" {{ old('has_certificate', true) ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Recommended: 300x200px, max 2MB</div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Recommended: 1200x400px, max 5MB</div>
            ...
            <div class="form-section">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="publish_immediately" name="publish_immediately" value="1">
